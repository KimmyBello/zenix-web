    ...
    return (
      ...
      <div className="flex flex-col items-center bg-gradient-to-t from-[#FFFFFF] to-transparent relative">
        ...
        <div className="relative flex flex-col max-w-screen-lg mx-auto justify-center w-1/2 rounded-lg shadow-2xl bg-white top-[140px] left-[120px]">
          <div className="box-border w-full p-4 md:p-6 lg:p-[20px] rounded-lg shadow-2xl">
            <span className="text-[#E71E26] text-center font-bold text-[20px] lg:text-[40px] block">
              Digital Transformation
            </span>
            <p className="mt-[10px] text-base text-[#424242] text-[14px] md:text-[16px] lg:text-[20px]">
